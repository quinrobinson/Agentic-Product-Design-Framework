...
const SKILL_FILES = [
  ...
  { file: "ux-copy-writing.md",        phase: "04", leverage: "high", surface: "chat",           desc: "Generate all interface text — labels, CTAs, error messages, empty states, onboarding copy, and microcopy — grounded in voice and user context." },
  { file: "user-flow-mapping.md",      phase: "04", leverage: "high", surface: "chat",           desc: "Map complete step-by-step user paths including decision points, error states, and edge cases — producing a screen inventory before wireframing begins." },
  { file: "prototype-scoping.md",      phase: "04", leverage: "high", surface: "chat",           desc: "Define the minimum prototype to answer the riskiest questions — scope, fidelity, and pass/fail criteria before building." },
  { file: "heuristic-review.md",       phase: "04", leverage: "high", surface: "chat",           desc: "Evaluate a prototype against Nielsen's 10 heuristics before usability testing — fixing obvious problems so testing surfaces deeper insights." },
  { file: "test-script-drafting.md",   phase: "04", leverage: "high", surface: "chat",           desc: "Write the usability test script — tasks, scenarios, probing questions, and observation guides — that bridges Prototype to Validate." },
